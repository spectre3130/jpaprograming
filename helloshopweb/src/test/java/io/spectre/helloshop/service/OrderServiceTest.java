...
import io.spectre.helloshop.domain.Address;
...
import io.spectre.helloshop.domain.item.Book;
import io.spectre.helloshop.domain.item.Item;
import io.spectre.helloshop.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    @Test
    public void 주문상품() throws Exception {
        ...
        assertEquals("주문 가격은 가격 * 구량 이다.", 10000 * 2, getOrder.getTotalPrice());
